...
MISSING_SPLIT_PATH = "missing_split_prefix_no_fire.txt"
...
BASE_PATH = "in_bucket_no_fire.txt"

NUM_THREADS = 10  # 🔥 IMPORTANT: EE-safe
...
def process_row(idx, row, split_sets):
    ...
    print(f"Submitted task for {base_name}")
    with counting_lock:
